...
public class TestApp {
	...
	public static void main(String[] args) {
		...
		//Requesting IOC container to give the Object
		 ...
		 wishMessageGenerator genetrator1= factory.getBean("wmg",wishMessageGenerator.class);
		 
		 System.out.println(genetrator.hashCode());
		 System.out.println(genetrator1.hashCode());
